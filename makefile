...
default: $(TEX).tex 
	$(LATEX) $(TEX); $(BIBTEX) other.aux; $(BIBTEX) pre.aux; $(BIBTEX) pres.aux; $(BIBTEX) peer.aux; $(BIBTEX) conf.aux; $(BIBTEX) talks.aux; $(BIBTEX) prog.aux; $(BIBTEX) unp.aux; $(LATEX) $(TEX); $(LATEX) $(TEX);
