...
\subsection{Current Appointments}
    ...
    \cventry{08/15 -- }{Member}{Kavli Neuroscience Discovery Institute (KNDI)}{}{}{}
...
\newline Role on project: Principal Investigator
\newline Term: \textcolor{red}{01-Jan-2020} to 30-June-2023
...
\todo{JOVO: Update start date or move to current}
...
\subsection{Undergraduate Student Supervision (8)}
    \cventry{06/19 -- }{Vivek Gopalakrishnan}{BSE}{BME}{JHU}{Winner of Pistritto Fellowship.}
    \cventry{06/19 -- }{Ronan Perry}{BSE}{BME}{JHU}{}
...
\section{Service}
\todo{Jovo:  NIH or NSF grant review service? }
\subsection{University Service}
    ...
    \cventry{08/15 -- 07/18}{Co-Developer}{\href{http://icm.jhu.edu/academics/undergraduate-minor/}{Computational Medicine Minor}}{For more information, please view as a PDF and click the weblink}{}{}
    \cventry{05/15 -- 07/17}{Co-Founder and Faculty Advisor}{\href{http://medhacks.org}{MedHacks}}{For more information, please view as a PDF and click the weblink}{}{}
...
\todo{JOVO: Fill in your memberships here}
...
\subsection{Advisory Board Appointments}
    \cventry{10/18 -- }{Advisory Board}{\href{https://mind-x.io/}{Mind-X}}{}{}{}
    \cventry{01/17 -- }{Advisory Board}{\href{https://www.pivotalpath.com/}{PivotalPath}}{}{}{}

\subsection{Startups}
    \cventry{01/17 -- }{Co-Founder}{\href{http://gigantum.io}{gigantum}}{The future of data science is open, decentralized and user friendly. That is why we created a platform that enables anybody to create and share totally reproducible computational work with the world. Our goal is to free people and organizations from the headaches and frustrations of the technical details so that they can concentrate on the creative work that is important to them and the world}{}{For more information, please view as a PDF and click the weblink.}
    \cventry{01/16 -- }{Co-Founder}{\href{http://www.d8alab.com}{d8alab}}{Our services include evaluating model performance, building prototype R/Shiny web applications and basic data cleaning. d8alab expert consulting offers high end academic faculty consulting regarding statistical, machine learning and data science issues and more}{}{For more information, please view as a PDF and click the weblink.}
