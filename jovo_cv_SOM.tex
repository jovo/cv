...
\subsection{Undergraduate Students (BME unless noted otherwise)}
    ...
    \cventry{08/20 -- }{Alisha Kodibagkar}{BSE}{BME}{JHU}{Assisting in the development of the brainlit code repository}
    \cventry{08/20 -- }{Shreya Singh}{BSE}{BME}{JHU}{Assisting in the development of the brainlit code repository}
