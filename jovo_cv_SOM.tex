...
\subsection{Staff Research Scientists (5)}
    \cventry{09/19 -- }{Ross Lawrence, BS}{Research Assistant}{BME}{JHU}{Current lead developer of NDMG, transitioning from a stand-alone package to be integrated with DiPy.}
    ...
    \cventry{10/18 -- }{Alex Loftus}{Research Assistant}{BME}{JHU}{Developer of NDMG, helping transition from a stand-alone package to be integrated with DiPy.}
