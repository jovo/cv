...
%\newrefcontext{J}
\nocite{*}
\defbibnote{a1}{{Note: CV author in bold; Trainees are italicized,
        \textsuperscript{*} indicates co-first, \textsection\, indicates
        co-corresponding.\\
        \textbf{(52 papers; top 10 cited 2,944 times; H-index 29)}}}
\printbibliography[%
...
\nocite{*}
\printbibliography[%
    title=\href{https://neurodata.io/posters/}{Abstracts and Poster Presentations},%
    heading=bibliography,%
    ]
\end{refsection}
...
\section{Service}
{\large{\textcolor{red}{Jovo: JLP sorted these, not sure if correct.}}}
